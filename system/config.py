...
UI_PRIMARY_GRADIENT_FROM = "#8b5cf6"
UI_PRIMARY_GRADIENT_TO = "#6366f1"
UI_ACCENT_COLOR = "#ec4899"
UI_SUCCESS_COLOR = "#10b981"
UI_WARNING_COLOR = "#f59e0b"
UI_DANGER_COLOR = "#ef4444"
UI_BG_COLOR = "#f8fafc"
UI_CARD_BG = "#ffffff"
UI_BORDER_COLOR = "#f1f5f9"
UI_TEXT_PRIMARY = "#1e293b"
UI_TEXT_SECONDARY = "#64748b"
UI_TEXT_MUTED = "#94a3b8"
UI_BORDER_RADIUS = "20px"
UI_BORDER_RADIUS_SM = "12px"
UI_BORDER_RADIUS_XS = "8px"
UI_SHADOW = "0 1px 3px rgba(0,0,0,0.03), 0 4px 20px rgba(0,0,0,0.02)"
UI_SHADOW_HOVER = "0 4px 24px rgba(139,92,246,0.06), 0 1px 4px rgba(0,0,0,0.03)"
