...
def _init_records_table(self):
    ...
    if 'id' not in existing_cols:
        _migrate_old_schema(cursor, existing_cols)
        cursor.execute("PRAGMA table_info(records)")
        existing_cols = {row[1] for row in cursor.fetchall()}
...
DBManager._init_records_table = _init_records_table
DBManager._init_webhooks_table = _init_webhooks_table
DBManager._init_push_history_table = _init_push_history_table
DBManager._init_lock_table = _init_lock_table
DBManager._init_invoice_details_table = _init_invoice_details_table
DBManager._init_duplicate_records_table = _init_duplicate_records_table
