...
def is_file_locked(self, file_path):
    ...
    try:
        ...
        conn.close()
        logger.error(f"检查文件锁异常: {file_path}, 错误: {e}")
        return False


DBManager.acquire_file_lock = acquire_file_lock
DBManager.release_file_lock = release_file_lock
DBManager.is_file_locked = is_file_locked
